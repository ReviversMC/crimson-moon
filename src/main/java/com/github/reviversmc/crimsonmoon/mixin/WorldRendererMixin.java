...
public class WorldRendererMixin {
    ...
    private void crimsonmoon_redirectMoonTexture(TextureManager textureManager, Identifier id) {
    ...
    private void crimsonmoon_redirectRainTexture(TextureManager textureManager, Identifier id) {
